...
fe_iov_status  fe_persistent_exists(const char *idb_name, const char *filename, fe_iov_rootdir rd) {return 0;}
fe_iov_promise fe_persistent_exists_async(const char *idb_name, const char *filename, fe_iov_rootdir rd) {return 0;}
fe_iov_status  fe_persistent_delete(const char *idb_name, const char *filename, fe_iov_rootdir rd) {return 0;}
