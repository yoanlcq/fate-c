CCFLAGS = -Iinclude
CCDEBUGFLAGS = $(CCFLAGS) -O0 -g -DFATE_DEBUG_BUILD -DFATE_ENABLE_TRACING
ifeq ($(OS),linux)
...
$(BUILDDIR)/$(2).o : src/$(2).c \
					 ...
					 $(if $(7),include/$(7),) \
					 $(if $(8),include/$(8),)
	$(CC) $(CCRELEASEFLAGS) -c src/$(2).c -o $(BUILDDIR)/$(2).o

$(BUILDDIR)/$(2)_debug.o : src/$(2).c \
                           $(if $(3),include/$(3),) \
					       $(if $(4),include/$(4),) \
					       $(if $(5),include/$(5),) \
					       $(if $(6),include/$(6),) \
					       $(if $(7),include/$(7),) \
					       $(if $(8),include/$(8),)
	$(CC) $(CCDEBUGFLAGS) -c src/$(2).c -o $(BUILDDIR)/$(2)_debug.o
