...
#ifndef FE_MATH_VEXT_I32V2_H
#define FE_MATH_VEXT_I32V2_H
...
#define fe_i32v2_add(s,a,b)   ((s).vx = (a).vx + (b).vx)
#define fe_i32v2_sub(s,a,b)   ((s).vx = (a).vx - (b).vx)
#define fe_i32v2_scale(r,v,s) ((r).vx = (v).vx * (s))
#define fe_i32v2_dot(a,b) fe_i32v2_mul_inner(a,b)
static inline int32_t fe_i32v2_mul_inner(const fe_i32v2 *a, const fe_i32v2 *b) {
    fe_i32v2 v = (fe_i32v2) {.vx = a->vx * b->vx};
