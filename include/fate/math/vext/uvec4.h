...
/* Feature test section */
 ...
 && __has_builtin(__builtin_shufflevector)
    ...
    #define fe_uvec4_shuffle(v,m) \
                __builtin_shufflevector(v,v,m[0],m[1],m[2],m[3])
    #define fe_uvec4_shuffle2(u,v,m) \
    ...
    #define FE_UVEC4_PACKED_ATTR  __attribute__((__packed__))
    #define fe_uvec4_shuffle(v,m)    __builtin_shuffle(v,m)
    #define fe_uvec4_shuffle2(u,v,m) __builtin_shuffle(u,v,m)
#endif
#endif
...
static inline void fe_uvec4p_mul_cross(fe_uvec4 *r, const fe_uvec4 a, const fe_uvec4 b) {
    ...
    const fe_uvec4 la = fe_uvec4_shuffle(a, s1);
    const fe_uvec4 lb = fe_uvec4_shuffle(b, s2);
    const fe_uvec4 ra = fe_uvec4_shuffle(a, s2);
    const fe_uvec4 rb = fe_uvec4_shuffle(b, s1);
    *r = la*lb - ra*rb;
    (*r)[3] = 1;
}
