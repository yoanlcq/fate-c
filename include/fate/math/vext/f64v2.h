...
#ifndef FE_MATH_VEXT_F64V2_H
#define FE_MATH_VEXT_F64V2_H
...
#include <fate/defs.h>
 ...
 && __has_builtin(__builtin_shufflevector)
    #define FE_F64V2_SIZE_ATTR(n) __attribute__((ext_vector_type(n)))
    #define FE_F64V2_PACKED_ATTR  __attribute__((__packed__))
    #define fe_f64v2_shuffle(v,a,b,c,d) \
                __builtin_shufflevector((v)->vx,(v)->vx,a,b,c,d)
    #define fe_f64v2_shuffle2(u,v,a,b,c,d) \
                __builtin_shufflevector((u)->vx,(v)->vx,a,b,c,d)
#endif
#elif defined(__GNUC__)
#if __GNUC__>4 || (__GNUC__==4 && __GNUC_MINOR__>=7)
    #define FE_F64V2_SIZE_ATTR(n) __attribute__((vector_size(n*sizeof(double))))
    #define FE_F64V2_PACKED_ATTR  __attribute__((__packed__))
    #define fe_f64v2_shuffle(v,a,b,c,d)    __builtin_shuffle((v)->vx,(fe_mask){a,b,c,d})
    #define fe_f64v2_shuffle2(u,v,a,b,c,d) __builtin_shuffle((u)->vx,(v)->vx,(fe_mask){a,b,c,d})
#endif
#endif

#ifndef FE_F64V2_SIZE_ATTR
...
typedef double fe_f64v2vext FE_F64V2_SIZE_ATTR(2);
...
FE_COMPILETIME_ASSERT(offsetof(fe_f64v2, r) == offsetof(fe_f64v2, at[0]), "");
FE_COMPILETIME_ASSERT(offsetof(fe_f64v2, g) == offsetof(fe_f64v2, at[1]), "");




#define fe_f64v2_add(s,a,b)   ((s).vx = (a).vx + (b).vx)
#define fe_f64v2_sub(s,a,b)   ((s).vx = (a).vx - (b).vx)
#define fe_f64v2_scale(r,v,s) ((r).vx = (v).vx * (s))
#define fe_f64v2_dot(a,b) fe_f64v2_mul_inner(a,b)
static inline double fe_f64v2_mul_inner(const fe_f64v2 *a, const fe_f64v2 *b) {
    fe_f64v2 v = (fe_f64v2) {.vx = a->vx * b->vx};
