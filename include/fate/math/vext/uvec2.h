...
/* Feature test section */
 ...
 && __has_builtin(__builtin_shufflevector)
    ...
    #define fe_uvec2_shuffle(v,a,b,c,d) \
                __builtin_shufflevector(v,v,a,b,c,d)
    #define fe_uvec2_shuffle2(u,v,a,b,c,d) \
    ...
    #define FE_UVEC2_PACKED_ATTR  __attribute__((__packed__))
    #define fe_uvec2_shuffle(v,a,b,c,d)    __builtin_shuffle(v,(fe_mask){a,b,c,d})
    #define fe_uvec2_shuffle2(u,v,a,b,c,d) __builtin_shuffle(u,v,(fe_mask){a,b,c,d})
#endif
#endif
