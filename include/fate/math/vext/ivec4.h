...
/* Feature test section */
 ...
 && __has_builtin(__builtin_shufflevector)
    ...
    #define fe_ivec4_shuffle(v,a,b,c,d) \
                __builtin_shufflevector(v,v,a,b,c,d)
    #define fe_ivec4_shuffle2(u,v,a,b,c,d) \
    ...
    #define FE_IVEC4_PACKED_ATTR  __attribute__((__packed__))
    #define fe_ivec4_shuffle(v,a,b,c,d)    __builtin_shuffle(v,(fe_uvec4){a,b,c,d})
    #define fe_ivec4_shuffle2(u,v,a,b,c,d) __builtin_shuffle(u,v,(fe_uvec4){a,b,c,d})
#endif
#endif
