...
#include <fate/defs.h>
 ...
 && __has_builtin(__builtin_shufflevector)
    ...
    #define fe_u64v3_shuffle(v,a,b,c,d) \
                __builtin_shufflevector((v)->vx,(v)->vx,a,b,c,d)
    #define fe_u64v3_shuffle2(u,v,a,b,c,d) \
    ...
    #define FE_U64V3_PACKED_ATTR  __attribute__((__packed__))
    #define fe_u64v3_shuffle(v,a,b,c,d)    __builtin_shuffle((v)->vx,(fe_u64v4){a,b,c,d})
    #define fe_u64v3_shuffle2(u,v,a,b,c,d) __builtin_shuffle((u)->vx,(v)->vx,(fe_u64v4){a,b,c,d})
#endif
#endif
...
static inline void fe_u64v3p_mul_cross(fe_u64v3 *r, const fe_u64v3 *a, const fe_u64v3 *b) {
    const fe_u64v3 la = (fe_u64v3) {.vx = fe_u64v3_shuffle(a, 1, 2, 0, 0)};
    const fe_u64v3 rb = (fe_u64v3) {.vx = fe_u64v3_shuffle(b, 1, 2, 0, 0)};
    const fe_u64v3 lb = (fe_u64v3) {.vx = fe_u64v3_shuffle(b, 2, 0, 1, 0)};
    const fe_u64v3 ra = (fe_u64v3) {.vx = fe_u64v3_shuffle(a, 2, 0, 1, 0)};
