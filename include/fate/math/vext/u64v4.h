...
static_assert(offsetof(fe_u64v4, r) == offsetof(fe_u64v4, at[0]), "");
static_assert(offsetof(fe_u64v4, g) == offsetof(fe_u64v4, at[1]), "");
static_assert(offsetof(fe_u64v4, b) == offsetof(fe_u64v4, at[2]), "");
static_assert(offsetof(fe_u64v4, a) == offsetof(fe_u64v4, at[3]), "");
...
static inline void fe_u64v4p_mul_cross(fe_u64v4 *r, const fe_u64v4 *a, const fe_u64v4 *b) {
    fe_u64v4 la; fe_u64v4_shuffle(&la, a, 1, 2, 0, 0);
    fe_u64v4 rb; fe_u64v4_shuffle(&rb, b, 1, 2, 0, 0);
    fe_u64v4 lb; fe_u64v4_shuffle(&lb, b, 2, 0, 1, 0);
    fe_u64v4 ra; fe_u64v4_shuffle(&ra, a, 2, 0, 1, 0);
