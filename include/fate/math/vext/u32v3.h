...
#ifndef FE_MATH_VEXT_U32V3_H
#define FE_MATH_VEXT_U32V3_H
...
FE_COMPILETIME_ASSERT(offsetof(fe_u32v3, r) == offsetof(fe_u32v3, at[0]), "");
FE_COMPILETIME_ASSERT(offsetof(fe_u32v3, g) == offsetof(fe_u32v3, at[1]), "");
FE_COMPILETIME_ASSERT(offsetof(fe_u32v3, b) == offsetof(fe_u32v3, at[2]), "");



#define fe_u32v3_add(s,a,b)   ((s).vx = (a).vx + (b).vx)
#define fe_u32v3_sub(s,a,b)   ((s).vx = (a).vx - (b).vx)
#define fe_u32v3_scale(r,v,s) ((r).vx = (v).vx * (s))
...
static inline uint32_t fe_u32v3_mul_inner(const fe_u32v3 *a, const fe_u32v3 *b) {
    fe_u32v3 v = (fe_u32v3) {.vx = a->vx * b->vx};
...
#define fe_u32v3_mul_cross_naive(r,a,b) fe_u32v3p_mul_cross_naive(&(r),a,b)
static inline void fe_u32v3p_mul_cross_naive(fe_u32v3 *r, const fe_u32v3 *a, const fe_u32v3 *b) {
