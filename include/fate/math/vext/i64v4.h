...
#ifndef FE_MATH_VEXT_I64V4_H
#define FE_MATH_VEXT_I64V4_H
...
#include <fate/defs.h>
 ...
 && __has_builtin(__builtin_shufflevector)
    #define FE_I64V4_SIZE_ATTR(n) __attribute__((ext_vector_type(n)))
    #define FE_I64V4_PACKED_ATTR  __attribute__((__packed__))
    #define fe_i64v4_shuffle(r,v,...) \
                do (r)->vx = __builtin_shufflevector((v)->vx,(v)->vx,__VA_ARGS__); while(0)
    #define fe_i64v4_shuffle2(r,u,v,...) \
                do (r)->vx = __builtin_shufflevector((u)->vx,(v)->vx,__VA_ARGS__); while(0)
#endif
#elif defined(__GNUC__)
#if __GNUC__>4 || (__GNUC__==4 && __GNUC_MINOR__>=7)
    #define FE_I64V4_SIZE_ATTR(n) __attribute__((vector_size(n*sizeof(int64_t))))
    #define FE_I64V4_PACKED_ATTR  __attribute__((__packed__))
    #define fe_i64v4_shuffle(r,v,...)    \
...
typedef int64_t fe_i64v4vext FE_I64V4_SIZE_ATTR(4);
...
FE_COMPILETIME_ASSERT(offsetof(fe_i64v4, r) == offsetof(fe_i64v4, at[0]), "");
FE_COMPILETIME_ASSERT(offsetof(fe_i64v4, g) == offsetof(fe_i64v4, at[1]), "");
FE_COMPILETIME_ASSERT(offsetof(fe_i64v4, b) == offsetof(fe_i64v4, at[2]), "");
FE_COMPILETIME_ASSERT(offsetof(fe_i64v4, a) == offsetof(fe_i64v4, at[3]), "");


#define fe_i64v4_add(s,a,b)   ((s).vx = (a).vx + (b).vx)
#define fe_i64v4_sub(s,a,b)   ((s).vx = (a).vx - (b).vx)
#define fe_i64v4_scale(r,v,s) ((r).vx = (v).vx * (s))
#define fe_i64v4_dot(a,b) fe_i64v4_mul_inner(a,b)
static inline int64_t fe_i64v4_mul_inner(const fe_i64v4 *a, const fe_i64v4 *b) {
    fe_i64v4 v = (fe_i64v4) {.vx = a->vx * b->vx};
...
/* TODO benchmark me */
#define fe_i64v4_mul_cross(r,a,b) fe_i64v4p_mul_cross(r,a,b)
#define fe_i64v4_cross(r,a,b)     fe_i64v4_mul_cross(r,a,b)
static inline void fe_i64v4p_mul_cross(fe_i64v4 *r, const fe_i64v4 *a, const fe_i64v4 *b) {
    fe_i64v4 la; fe_i64v4_shuffle(&la, a, 1, 2, 0, 0);
    fe_i64v4 rb; fe_i64v4_shuffle(&rb, b, 1, 2, 0, 0);
    fe_i64v4 lb; fe_i64v4_shuffle(&lb, b, 2, 0, 1, 0);
    fe_i64v4 ra; fe_i64v4_shuffle(&ra, a, 2, 0, 1, 0);
    r->vx = la.vx*lb.vx - ra.vx*rb.vx;
    r->vx[3] = 1;
}

/* TODO should be discarded if proven to be less efficient. */
#define fe_i64v4_mul_cross_naive(r,a,b) fe_i64v4p_mul_cross_naive(&(r),a,b)
static inline void fe_i64v4p_mul_cross_naive(fe_i64v4 *r, const fe_i64v4 *a, const fe_i64v4 *b) {
