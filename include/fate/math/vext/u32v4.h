...
#include <fate/defs.h>
 ...
 && __has_builtin(__builtin_shufflevector)
    ...
    #define fe_u32v4_shuffle(v,a,b,c,d) \
                __builtin_shufflevector((v)->vx,(v)->vx,a,b,c,d)
    #define fe_u32v4_shuffle2(u,v,a,b,c,d) \
    ...
    #define FE_U32V4_PACKED_ATTR  __attribute__((__packed__))
    #define fe_u32v4_shuffle(v,a,b,c,d)    __builtin_shuffle((v)->vx,(fe_u32v4){a,b,c,d})
    #define fe_u32v4_shuffle2(u,v,a,b,c,d) __builtin_shuffle((u)->vx,(v)->vx,(fe_u32v4){a,b,c,d})
#endif
#endif
...
static inline void fe_u32v4p_mul_cross(fe_u32v4 *r, const fe_u32v4 *a, const fe_u32v4 *b) {
    const fe_u32v4 la = (fe_u32v4) {.vx = fe_u32v4_shuffle(a, 1, 2, 0, 0)};
    const fe_u32v4 rb = (fe_u32v4) {.vx = fe_u32v4_shuffle(b, 1, 2, 0, 0)};
    const fe_u32v4 lb = (fe_u32v4) {.vx = fe_u32v4_shuffle(b, 2, 0, 1, 0)};
    const fe_u32v4 ra = (fe_u32v4) {.vx = fe_u32v4_shuffle(a, 2, 0, 1, 0)};
