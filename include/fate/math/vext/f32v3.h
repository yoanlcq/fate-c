...
#include <fate/defs.h>
 ...
 && __has_builtin(__builtin_shufflevector)
    ...
    #define fe_f32v3_shuffle(v,a,b,c,d) \
                __builtin_shufflevector((v)->vx,(v)->vx,a,b,c,d)
    #define fe_f32v3_shuffle2(u,v,a,b,c,d) \
    ...
    #define FE_F32V3_PACKED_ATTR  __attribute__((__packed__))
    #define fe_f32v3_shuffle(v,a,b,c,d)    __builtin_shuffle((v)->vx,(fe_u32v4){a,b,c,d})
    #define fe_f32v3_shuffle2(u,v,a,b,c,d) __builtin_shuffle((u)->vx,(v)->vx,(fe_u32v4){a,b,c,d})
#endif
#endif
...
static inline void fe_f32v3p_mul_cross(fe_f32v3 *r, const fe_f32v3 *a, const fe_f32v3 *b) {
    const fe_f32v3 la = (fe_f32v3) {.vx = fe_f32v3_shuffle(a, 1, 2, 0, 0)};
    const fe_f32v3 rb = (fe_f32v3) {.vx = fe_f32v3_shuffle(b, 1, 2, 0, 0)};
    const fe_f32v3 lb = (fe_f32v3) {.vx = fe_f32v3_shuffle(b, 2, 0, 1, 0)};
    const fe_f32v3 ra = (fe_f32v3) {.vx = fe_f32v3_shuffle(a, 2, 0, 1, 0)};
