...
typedef fe_i32v4vext fe_i32v3vext;
...
fe_static_assert(offsetof(fe_i32v3, r) == offsetof(fe_i32v3, at[0]), "");
fe_static_assert(offsetof(fe_i32v3, g) == offsetof(fe_i32v3, at[1]), "");
fe_static_assert(offsetof(fe_i32v3, b) == offsetof(fe_i32v3, at[2]), "");
...
static inline void fe_i32v3p_mul_cross(fe_i32v3 *r, const fe_i32v3 *a, const fe_i32v3 *b) {
    fe_i32v3 la; fe_i32v3_shuffle(&la, a, 1, 2, 0, 0);
    fe_i32v3 rb; fe_i32v3_shuffle(&rb, b, 1, 2, 0, 0);
    fe_i32v3 lb; fe_i32v3_shuffle(&lb, b, 2, 0, 1, 0);
    fe_i32v3 ra; fe_i32v3_shuffle(&ra, a, 2, 0, 1, 0);
