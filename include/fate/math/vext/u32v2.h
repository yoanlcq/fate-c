...
#include <fate/defs.h>
 ...
 && __has_builtin(__builtin_shufflevector)
    ...
    #define fe_u32v2_shuffle(v,a,b,c,d) \
                __builtin_shufflevector((v)->vx,(v)->vx,a,b,c,d)
    #define fe_u32v2_shuffle2(u,v,a,b,c,d) \
    ...
    #define FE_U32V2_PACKED_ATTR  __attribute__((__packed__))
    #define fe_u32v2_shuffle(v,a,b,c,d)    __builtin_shuffle((v)->vx,(fe_mask){a,b,c,d})
    #define fe_u32v2_shuffle2(u,v,a,b,c,d) __builtin_shuffle((u)->vx,(v)->vx,(fe_mask){a,b,c,d})
#endif
#endif
