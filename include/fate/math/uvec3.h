 ...
 * fe_uvec3
 */
typedef struct { uint32_t at[3]; } fe_uvec3;

/*! \brief TODO */
struct FE_DECL_PACKED_STRUCT fe_uvec3_color {
    uint32_t r;
    uint32_t g;
    uint32_t b;
    /* No alpha component. */
...
/*! \brief TODO */
struct FE_DECL_PACKED_STRUCT fe_uvec3_coord {
    uint32_t x;
    uint32_t y;
    uint32_t z;
    /* No w component. */
...
/*! \brief TODO */
#define fe_uvec3_as_array(v) (v.at)
/*! \brief TODO */
