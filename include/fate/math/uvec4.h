 ...
 * fe_uvec4
 */
typedef struct { uint32_t at[4]; } fe_uvec4;

/*! \brief TODO */
struct FE_DECL_PACKED_STRUCT fe_uvec4_color {
    uint32_t r;
    uint32_t g;
    uint32_t b;
    uint32_t a;
...
/*! \brief TODO */
struct FE_DECL_PACKED_STRUCT fe_uvec4_coord {
    uint32_t x;
    uint32_t y;
    uint32_t z;
    uint32_t w;
...
/*! \brief TODO */
#define fe_uvec4_as_array(v) (v.at)
/*! \brief TODO */
